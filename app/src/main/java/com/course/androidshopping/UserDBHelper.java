...
public class UserDBHelper extends SQLiteOpenHelper {
    ...
    public long insertUser(com.course.androidshopping.UserBean user){
    ...
    public ArrayList<com.course.androidshopping.UserBean> getAllUser(){
        SQLiteDatabase db = getReadableDatabase();
        Cursor cursor = db.query(TABLE_NAME, null, null, null, null, null, null);
        ArrayList<com.course.androidshopping.UserBean> result = new ArrayList<>();

        while(cursor.moveToNext()){
            com.course.androidshopping.UserBean user = new com.course.androidshopping.UserBean();
    ...
    public ArrayList<com.course.androidshopping.UserBean> getUserById(String id){
        SQLiteDatabase db = getReadableDatabase();
    ...
    public long deleteUser(com.course.androidshopping.UserBean bean){
        SQLiteDatabase db = getWritableDatabase();
